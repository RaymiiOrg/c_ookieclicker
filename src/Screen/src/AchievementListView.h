...
class AchievementListView : public View {
    ...
    AchievementList<CookieAmountAchievement> cookieAmountAchievementList =
    AchievementList<CookieAmountAchievement>(std::vector<CookieAmountAchievement*>());
    AchievementView cookieAmountAchievementView = AchievementView("Cookie Amount");

    AchievementList<CookiesPerSecondAchievement> cookiesPerSecondAchievements =
    AchievementList<CookiesPerSecondAchievement>(std::vector<CookiesPerSecondAchievement*>());
