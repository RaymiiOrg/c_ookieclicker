...
{
    testing::internal::CaptureStdout();
    std::vector<CookieNumber> numbers{CookieNumber(424242),
...
{
    testing::internal::CaptureStdout();
    std::vector<CookieNumber> numbers{CookieNumber(424242.897),
...
{
    testing::internal::CaptureStdout();
    std::vector<CookieInt> numbers{CookieInt(424242),
                                      CookieInt(9999999),
                                      CookieInt(42424242),
                                      CookieInt(100000000),
