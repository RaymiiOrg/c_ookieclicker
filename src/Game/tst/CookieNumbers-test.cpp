...
{
    testing::internal::CaptureStdout();
    std::vector<CookieNumber> numbers{CookieNumber(123456),
                                      CookieNumber(424242),
...
{
    testing::internal::CaptureStdout();
    std::vector<CookieNumber> numbers{CookieNumber(123456.789),
...
{
    testing::internal::CaptureStdout();
    std::vector<CookieInt> numbers{CookieInt(123456),
                                   CookieInt(424242),
                                   CookieInt(9999999),
                                   CookieInt(42424242),
                                   CookieInt(100000000),
